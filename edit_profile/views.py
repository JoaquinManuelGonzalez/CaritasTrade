        ...
        if edit_form.is_valid():
            ...
            if password and new_password:
                if user.password == password:
                    ...
                    edit_form.add_error(
                    None, "Sus datos personales no han sido modificados. La Contraseña actual es incorrecta. Intente Nuevamente."
                    )
            ...
            user.save()
            return render(request, "edit_success_message.html",{
