# Generated by Django 5.0.4 on 2024-05-11 01:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField()),
                ('affiliate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data_base.affiliate')),
                ('exchange_post_for', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exchange_post_for', to='data_base.exchangepost')),
                ('in_exchange_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='in_exchange_post', to='data_base.exchangepost')),
                ('affiliate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data_base.affiliate')),
                ('exchange_post_for', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exchange_post_for', to='data_base.exchangepost')),
                ('in_exchange_post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='in_exchange_post', to='data_base.exchangepost')),
            ],
